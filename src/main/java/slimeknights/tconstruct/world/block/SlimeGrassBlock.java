...
public class SlimeGrassBlock extends SnowyBlock implements BonemealableBlock {
  @Getter
  ...
  private static boolean isValidPos(BlockState targetState, LevelReader world, BlockPos pos) {
    ...
    // Match vanilla's light opacity check. The 26.1 API exposes the shape-aware
    // LightEngine overload instead of the older Level/BlockPos overload.
