...
public class InvertedCakeBlock extends FoodCakeBlock {
  ...
  public InvertedCakeBlock(Properties properties, FoodProperties food, EffectCombination combination, List<FoodCakeBlock.FoodEffect> effects) {
    super(properties, food, combination, effects);
  }
