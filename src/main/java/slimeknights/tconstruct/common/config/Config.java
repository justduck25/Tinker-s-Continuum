...
//        .define("temperatureInCelsius", true);
  ...
  public static void init() {
    ModLoadingContext.get().getActiveContainer().registerConfig(Type.CLIENT, clientSpec);
    ModLoadingContext.get().getActiveContainer().registerConfig(Type.COMMON, commonSpec);
  }
