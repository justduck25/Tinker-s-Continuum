...
public enum SmelteryCompat {
  ...
  private final FluidObject<? extends FlowingFluid> fluid;
  ...
  SmelteryCompat(FluidObject<? extends FlowingFluid> fluid, CompatType type, @Nullable MaterialId material) {
    this.fluid = fluid;
    this.type = type;
  ...
  SmelteryCompat(FluidObject<? extends FlowingFluid> fluid, CompatType type) {
