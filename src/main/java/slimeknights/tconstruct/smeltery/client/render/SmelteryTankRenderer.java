...
public class SmelteryTankRenderer {
  ...
  public static void renderFluids(PoseStack matrices, MultiBufferSource buffer, SmelteryTank<?> tank,
    ...
    if(!fluids.isEmpty()) {
      ...
      renderFluids(matrices, builder, fluids, tank.getCapacity(), tankMinPos, tankMaxPos, brightness);
    }
  }

  public static void renderFluids(PoseStack matrices, VertexConsumer builder, SmelteryTank<?> tank,
                                  BlockPos tankMinPos, BlockPos tankMaxPos, int brightness) {
    renderFluids(matrices, builder, tank.getFluids(), tank.getCapacity(), tankMinPos, tankMaxPos, brightness);
  }

  public static void renderFluids(PoseStack matrices, VertexConsumer builder, List<FluidStack> fluids, int capacity,
                                   BlockPos tankMinPos, BlockPos tankMaxPos, int brightness) {
  ...
  private static void renderLargeFluidCuboid(PoseStack matrices, VertexConsumer builder, FluidStack fluid, int brightness,
    ...
    TextureAtlasSprite still = FluidRenderer.getBlockSprite(RenderUtils.getStillTexture(fluid, fluidType));
