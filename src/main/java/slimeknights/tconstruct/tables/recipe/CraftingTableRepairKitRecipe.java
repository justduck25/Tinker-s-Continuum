...
public class CraftingTableRepairKitRecipe extends CustomRecipe {
  ...
  public boolean matches(CraftingInput inv, Level worldIn) {
    ...
    MaterialId inputMaterial = IMaterialItem.getMaterialFromStack(inputs.repairKit).getMaterialId();
  ...
  protected float getRepairAmount(IToolStackView tool, ItemStack repairStack) {
    return MaterialRepairToolHook.repairAmount(tool, IMaterialItem.getMaterialFromStack(repairStack).getMaterialId());
  }
