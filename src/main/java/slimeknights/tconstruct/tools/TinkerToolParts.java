...
public final class TinkerToolParts extends TinkerModule {
  ...
  // armor
  public static final EnumObject<ArmorType,ToolPartItem> plating = ITEMS.registerEnum(ModifiableArmorMaterial.ARMOR_TYPES, "plating", type -> new ToolPartItem(ITEM_PROPS, PlatingMaterialStats.TYPES.get(type.ordinal()).getStatsId()));
  ...
  // slimesuit
  public static final ItemObject<ToolPartItem> ribcage = ITEMS.register("ribcage", () -> new ToolPartItem(ITEM_PROPS, RepairStats.RIBCAGE.getStatsId()));
  public static final ItemObject<ToolPartItem> shell = ITEMS.register("shell", () -> new ToolPartItem(ITEM_PROPS, RepairStats.SHELL.getStatsId()));
  public static final ItemObject<ToolPartItem> laces = ITEMS.register("laces", () -> new ToolPartItem(ITEM_PROPS, RepairStats.LACES.getStatsId()));
  ...
  // loot
  public static final DeferredHolder<MapCodec<? extends LootPoolEntryContainer>, MapCodec<ToolPartLootEntry>> toolPartLootEntry = LOOT_ENTRIES.register("tool_part", () -> ToolPartLootEntry.CODEC);
