...
public record HeadMaterialStats(int durability, float miningSpeed, ToolMaterial tier, float attack) implements IRepairableMaterialStats.ScaledTooltip {
  ...
  public static final MaterialStatType<HeadMaterialStats> TYPE = new MaterialStatType<>(ID, new HeadMaterialStats(1, 1f, HarvestTiers.minTier(), 1f), RecordLoadable.create(
    ...
    TinkerLoadables.TIER.defaultField("mining_tier", HarvestTiers.minTier(), true, HeadMaterialStats::tier),
