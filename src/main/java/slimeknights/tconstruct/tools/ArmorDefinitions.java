...
public class ArmorDefinitions {
  ...
  public static final ToolDefinition TRAVELERS_SHIELD = ToolDefinition.create(getResource("travelers_shield"));
  ...
  public static final ToolDefinition PLATE_SHIELD = ToolDefinition.create(getResource("plate_shield"));
  ...
  public static final ToolDefinition SLIME_WINGS = ToolDefinition.create(getResource("slime_wings"));
}
