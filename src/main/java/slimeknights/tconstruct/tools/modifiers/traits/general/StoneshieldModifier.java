...
public class StoneshieldModifier extends Modifier {
  ...
  protected void registerHooks(Builder hookBuilder) {
    ...
    hookBuilder.addModule(LootToCapacityModule.consume(slimeknights.tconstruct.library.recipe.ingredient.LegacyIngredientType.ofTag(TinkerTags.Items.STONESHIELDS)).amount(3).eachLevel(0.2f));
  }
