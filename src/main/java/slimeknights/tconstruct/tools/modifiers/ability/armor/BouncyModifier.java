...
public class BouncyModifier extends NoLevelsModifier {
  ...
  protected void registerHooks(Builder hookBuilder) {
    ...
    hookBuilder.addModule(AttributeModule.builder(TinkerAttributes.BOUNCY, Operation.ADD_VALUE).uniqueFrom(getId().getId()).tooltipStyle(TooltipStyle.NONE).flat(1));
  }
}
