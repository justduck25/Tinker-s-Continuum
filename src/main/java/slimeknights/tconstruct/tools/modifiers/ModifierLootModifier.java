...
public class ModifierLootModifier extends LootModifier {
  ...
  protected ObjectArrayList<ItemStack> doApply(ObjectArrayList<ItemStack> generatedLoot, LootContext context) {
    // tool is for harvest
    ItemStack stack = context.getOptionalParameter(LootContextParams.TOOL) instanceof ItemStack itemStack ? itemStack : null;
    ...
    if (stack == null) {
      ...
      if (damageSource != null && damageSource.is(TinkerTags.DamageTypes.LOOT_MODIFIER_WHITELIST) && context.getOptionalParameter(LootContextParams.ATTACKING_ENTITY) instanceof LivingEntity living) {
