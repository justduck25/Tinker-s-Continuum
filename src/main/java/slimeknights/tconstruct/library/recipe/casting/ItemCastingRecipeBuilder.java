...
public class ItemCastingRecipeBuilder extends AbstractRecipeBuilder<ItemCastingRecipeBuilder> {
  ...
  public static ItemCastingRecipeBuilder basinRecipe(ItemOutput result) {
    return castingRecipe(result, TinkerSmeltery.typeAware(TinkerRecipeTypes.CASTING_BASIN, TinkerSmeltery.basinRecipeSerializer));
  }
  ...
  public static ItemCastingRecipeBuilder retexturedBasinRecipe(ItemOutput result) {
    return castingRecipe(result, TinkerSmeltery.typeAware(TinkerRecipeTypes.CASTING_BASIN, TinkerSmeltery.retexturedBasinRecipeSerializer));
  }
  ...
  public static ItemCastingRecipeBuilder basinDuplication() {
    return castingRecipe(ItemOutput.EMPTY, TinkerSmeltery.typeAware(TinkerRecipeTypes.CASTING_BASIN, TinkerSmeltery.basinDuplicationRecipeSerializer));
  }
  ...
  public static ItemCastingRecipeBuilder tableRecipe(ItemOutput resultIn) {
    return castingRecipe(resultIn, TinkerSmeltery.typeAware(TinkerRecipeTypes.CASTING_TABLE, TinkerSmeltery.tableRecipeSerializer));
  }
  ...
  public static ItemCastingRecipeBuilder retexturedTableRecipe(ItemOutput resultIn) {
    return castingRecipe(resultIn, TinkerSmeltery.typeAware(TinkerRecipeTypes.CASTING_TABLE, TinkerSmeltery.retexturedTableRecipeSerializer));
  }
  ...
  public static ItemCastingRecipeBuilder tableDuplication() {
    return castingRecipe(ItemOutput.EMPTY, TinkerSmeltery.typeAware(TinkerRecipeTypes.CASTING_TABLE, TinkerSmeltery.tableDuplicationRecipeSerializer));
  }
   ...
   */
  /**
   * Sets the fluid, time determined by fluid properties and amount
   */
  public ItemCastingRecipeBuilder setFluidAndTime(Fluid fluid, int amount) {
  ...
  public ItemCastingRecipeBuilder setCast(TagKey<Item> tagIn, boolean consumed) {
    return this.setCast(slimeknights.tconstruct.library.recipe.ingredient.LegacyIngredientType.ofTag(tagIn), consumed);
  }
  ...
  public void save(RecipeOutput consumer, Identifier id) {
    ...
    if (result == ItemOutput.EMPTY) {
      ...
      consumer.accept(key, new CastDuplicationRecipe(recipeSerializer, id, group, cast, fluid, coolingTime), advancement);
    } else {
      ...
      consumer.accept(key, new ItemCastingRecipe(recipeSerializer, id, group, cast, fluid, result, coolingTime, consumed && cast != slimeknights.mantle.recipe.ingredient.EmptyIngredient.VANILLA, switchSlots), advancement);
    }
  }
}
