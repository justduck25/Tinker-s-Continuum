...
public class PotionCastingRecipeBuilder extends AbstractRecipeBuilder<PotionCastingRecipeBuilder> {
  ...
  private Ingredient bottle = AbstractCastingRecipe.EMPTY_INGREDIENT;
  ...
  public static PotionCastingRecipeBuilder basinRecipe(ItemLike result) {
    return castingRecipe(result, TinkerSmeltery.typeAware(TinkerRecipeTypes.CASTING_BASIN, TinkerSmeltery.basinPotionRecipeSerializer));
  }
  ...
  public static PotionCastingRecipeBuilder tableRecipe(ItemLike result) {
    return castingRecipe(result, TinkerSmeltery.typeAware(TinkerRecipeTypes.CASTING_TABLE, TinkerSmeltery.tablePotionRecipeSerializer));
  }
  ...
  public static PotionCastingRecipeBuilder basinTipping(ModifierId modifier) {
    return tippingRecipe(modifier, TinkerSmeltery.typeAware(TinkerRecipeTypes.CASTING_BASIN, TinkerSmeltery.basinTippingRecipeSerializer));
  }
  ...
  public static PotionCastingRecipeBuilder tableTipping(ModifierId modifier) {
    return tippingRecipe(modifier, TinkerSmeltery.typeAware(TinkerRecipeTypes.CASTING_TABLE, TinkerSmeltery.tableTippingRecipeSerializer));
  }
  ...
  public static PotionCastingRecipeBuilder basinClearing(ModifierId modifier) {
    return tippingRecipe(modifier, TinkerSmeltery.typeAware(TinkerRecipeTypes.CASTING_BASIN, TinkerSmeltery.basinTipClearingRecipeSerializer));
  }
  ...
  public static PotionCastingRecipeBuilder tableClearing(ModifierId modifier) {
    return tippingRecipe(modifier, TinkerSmeltery.typeAware(TinkerRecipeTypes.CASTING_TABLE, TinkerSmeltery.tableTipClearingRecipeSerializer));
  }
  ...
  public PotionCastingRecipeBuilder setBottle(TagKey<Item> tagIn) {
    return this.setBottle(tagIngredient(tagIn));
  }
  ...
  public void save(RecipeOutput consumer, Identifier id) {
    ...
    if (modifier != null) {
      if (recipeSerializer.getSerializer() == TinkerSmeltery.basinTipClearingRecipeSerializer.get() || recipeSerializer.getSerializer() == TinkerSmeltery.tableTipClearingRecipeSerializer.get()) {
        consumer.accept(key, new TipClearingCastingRecipe(recipeSerializer, id, group, bottle, fluid, coolingTime, modifier), advancement);
      } else {
        consumer.accept(key, new TippingCastingRecipe(recipeSerializer, id, group, bottle, fluid, coolingTime, modifier), advancement);
      }
    } else {
      consumer.accept(key, new PotionCastingRecipe(recipeSerializer, id, group, bottle, fluid, result, coolingTime), advancement);
    }
  }
}
