...
public class MaterialRecipe implements ICustomOutputRecipe<ISingleStackContainer>, IMaterialValue {
  ...
  private static final Ingredient EMPTY_INGREDIENT = slimeknights.mantle.recipe.ingredient.EmptyIngredient.VANILLA;
  public static final MaterialRecipe EMPTY = new MaterialRecipe(Identifier.parse("missingno"), "", EMPTY_INGREDIENT, 0, 0, IMaterial.UNKNOWN_ID, ItemOutput.EMPTY);
  ...
  @Override
  public RecipeType<? extends Recipe<ISingleStackContainer>> getType() {
  ...
  @Override
  public RecipeSerializer<? extends Recipe<ISingleStackContainer>> getSerializer() {
  ...
  public NonNullList<Ingredient> getIngredients() {
    return NonNullList.of(EMPTY_INGREDIENT, ingredient);
  }
