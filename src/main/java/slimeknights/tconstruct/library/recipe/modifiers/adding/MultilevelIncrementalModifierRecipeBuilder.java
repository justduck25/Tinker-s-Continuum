...
public class MultilevelIncrementalModifierRecipeBuilder extends AbstractMultilevelModifierRecipeBuilder<MultilevelIncrementalModifierRecipeBuilder> {
  ...
  public void save(RecipeOutput consumer, Identifier id) {
    ...
    consumer.accept(key, new MultilevelIncrementalModifierRecipe(id, input, amountPerItem, neededPerLevel, tools, maxToolSize, result, leftover, allowCrystal, levels, checkTraitLevel), buildOptionalAdvancement(key, "modifiers"));
  }
}
