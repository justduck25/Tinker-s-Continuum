...
public class MultilevelModifierRecipeBuilder extends AbstractMultilevelModifierRecipeBuilder<MultilevelModifierRecipeBuilder> {
  ...
  public void save(RecipeOutput consumer, Identifier id) {
    ...
    consumer.accept(key, new MultilevelModifierRecipe(id, inputs, tools, maxToolSize, result, allowCrystal, levels, checkTraitLevel), buildOptionalAdvancement(key, "modifiers"));
  }
}
