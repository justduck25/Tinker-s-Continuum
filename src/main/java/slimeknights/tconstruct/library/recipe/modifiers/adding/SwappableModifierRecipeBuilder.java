...
public class SwappableModifierRecipeBuilder extends ModifierRecipeBuilder {
  ...
  public void save(RecipeOutput consumer, Identifier id) {
    ...
    consumer.accept(key, new SwappableModifierRecipe(id, inputs, tools, maxToolSize, result, value, variantFormatter, slots, allowCrystal), buildOptionalAdvancement(key, "modifiers"));
  }
}
