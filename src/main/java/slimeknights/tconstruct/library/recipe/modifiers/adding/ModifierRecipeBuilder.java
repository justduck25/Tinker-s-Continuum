...
public class ModifierRecipeBuilder extends AbstractModifierRecipeBuilder<ModifierRecipeBuilder> {
  ...
  public ModifierRecipeBuilder addInput(TagKey<Item> tag, int amount) {
    return addInput(SizedIngredient.of(tagIngredient(tag), amount));
  }
  ...
  public void save(RecipeOutput consumer, Identifier id) {
    ...
    consumer.accept(key, new ModifierRecipe(id, inputs, tools, maxToolSize, result, ModifierEntry.VALID_LEVEL.range(minLevel, maxLevel), slots, allowCrystal, checkTraitLevel), buildOptionalAdvancement(key, "modifiers"));
  }
}
