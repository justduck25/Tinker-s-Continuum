...
public class PartRecipe implements IPartBuilderRecipe, IMultiRecipe<IDisplayPartBuilderRecipe> {
  ...
  @Override
  public RecipeSerializer<? extends Recipe<IPartBuilderContainer>> getSerializer() {
    ...
    if (multiRecipes == null) {
      multiRecipes = MaterialRegistry
        ...
        .flatMap(mat -> {
          ...
          return Stream.of(new DisplayPartRecipe(id, materialTitle, pattern, MaterialRecipeCache.getDisplayItems(patternItem), getCost(), materialItems, resultItems));
        })
