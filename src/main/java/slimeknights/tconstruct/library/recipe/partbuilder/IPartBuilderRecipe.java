...
public interface IPartBuilderRecipe extends ICommonRecipe<IPartBuilderContainer> {
  ...
  Ingredient DEFAULT_PATTERNS = slimeknights.tconstruct.library.recipe.ingredient.LegacyIngredientType.ofTag(TinkerTags.Items.DEFAULT_PATTERNS);
  ...
  @Override
  default RecipeType<? extends Recipe<IPartBuilderContainer>> getType() {
