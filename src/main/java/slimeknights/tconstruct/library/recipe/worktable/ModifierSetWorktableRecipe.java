...
public class ModifierSetWorktableRecipe extends AbstractWorktableRecipe {
  ...
  public static final BiFunction<CompoundTag, String, ListTag> LIST_GETTER = (tag, name) -> tag.getList(name).orElseGet(ListTag::new);
  /** Loader instance */
  ...
  @Override
  public RecipeSerializer<? extends Recipe<ITinkerableContainer>> getSerializer() {
