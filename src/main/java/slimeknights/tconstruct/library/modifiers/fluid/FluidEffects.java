...
public record FluidEffects(FluidIngredient ingredient, List<FluidEffect<? super FluidEffectContext.Block>> blockEffects, List<FluidEffect<? super FluidEffectContext.Entity>> entityEffects, boolean hidden) {
  ...
  private <C extends FluidEffectContext> int apply(FluidStack fluid, float level, C context, List<FluidEffect<? super C>> effects, net.neoforged.neoforge.fluids.capability.IFluidHandler.FluidAction action) {
   ...
   * @param action   If {@link net.neoforged.neoforge.fluids.capability.IFluidHandler.FluidAction#SIMULATE}, makes no changes to the context. If {@link net.neoforged.neoforge.fluids.capability.IFluidHandler.FluidAction#EXECUTE}, the context may be modified.
  ...
  public int applyToBlock(FluidStack fluid, float level, Block context, net.neoforged.neoforge.fluids.capability.IFluidHandler.FluidAction action) {
   ...
   */
  public int applyToEntity(FluidStack fluid, float level, Entity context, net.neoforged.neoforge.fluids.capability.IFluidHandler.FluidAction action) {
