...
public record MobEffectFluidEffect(FluidMobEffect effect, TimeAction action) implements FluidEffect<FluidEffectContext.Entity> {
  ...
  @Override
  public float apply(FluidStack fluid, EffectLevel scale, FluidEffectContext.Entity context, net.neoforged.neoforge.fluids.capability.IFluidHandler.FluidAction action) {
    // first, need a target
