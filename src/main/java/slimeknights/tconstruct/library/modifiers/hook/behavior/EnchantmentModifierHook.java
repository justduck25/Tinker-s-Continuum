...
public interface EnchantmentModifierHook {
  ...
  /**
   * Gets the enchantment level for the given tool using NeoForge's gameplay enchantment holder API.
  ...
  /**
   * Gets all gameplay enchantments on the given stack using NeoForge's holder API.
   * @param stack  Stack instance
   * @param lookup Registry lookup used to resolve holder keys
   * @return  All contained enchantments
   */
  static ItemEnchantments getAllEnchantments(ItemStack stack, RegistryLookup<Enchantment> lookup) {
