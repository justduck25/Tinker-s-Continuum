...
public interface EnchantmentModule extends ModifierModule, LevelingIntModule, ConditionalModule<IToolStackView> {
  /* Common fields */
  LoadableField<Enchantment,EnchantmentModule> ENCHANTMENT = slimeknights.tconstruct.library.json.TinkerEnchantmentLoadable.INSTANCE.requiredField("name", EnchantmentModule::enchantment);
