...
public class MutableUseOnContext extends UseOnContext {
  private final MutableBlockPos offsetPos;
  @Getter
  private Vec3 clickedLocation;
  public MutableUseOnContext(UseOnContext base) {
    this(base.getLevel(), base.getPlayer(), base.getHand(), base.getItemInHand(), new BlockHitResult(base.getClickLocation(), base.getClickedFace(), base.getClickedPos(), false));
  }
  ...
  public MutableUseOnContext(Level pLevel, @Nullable Player pPlayer, InteractionHand pHand, ItemStack pItemStack, BlockHitResult pHitResult) {
    ...
    this.offsetPos = new MutableBlockPos(super.getClickedPos().getX(), super.getClickedPos().getY(), super.getClickedPos().getZ());
  ...
  public void setOffsetPos(BlockPos offset) {
    ...
    offsetPos.set(offset.getX(), offset.getY(), offset.getZ());
  }
}
