...
public class MultiplierNBT {
  ...
  public static MultiplierNBT readFromNBT(@Nullable Tag inbt) {
    ...
    for (String key : nbt.keySet()) {
      if (StatsNBT.readStatIdFromNBT(key) instanceof INumericToolStat<?> stat) {
        nbt.getFloat(key).ifPresent(value -> builder.set(stat, value));
      }
    }
  ...
  public boolean equals(@Nullable Object o) {
    ...
    MultiplierNBT that = (MultiplierNBT) o;
  ...
  public String toString() {
    return "MultiplierNBT(stats=" + stats + ")";
  }
