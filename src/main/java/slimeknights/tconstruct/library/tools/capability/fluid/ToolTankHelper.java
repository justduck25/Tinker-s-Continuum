...
public class ToolTankHelper {
  ...
  public static final BiFunction<CompoundTag, String, FluidStack> PARSE_FLUID = FluidStackNbt::read;
  ...
  public FluidStack setFluid(IToolStackView tool, FluidStack fluid) {
    ...
    tool.getPersistentData().put(fluidKey, FluidStackNbt.write(fluid));
    return fluid;
  }
}
