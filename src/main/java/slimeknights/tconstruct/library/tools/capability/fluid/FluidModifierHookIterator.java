...
abstract class FluidModifierHookIterator<I> extends CompoundIndexHookIterator<FluidModifierHook,I> {
   ...
   */
  protected int fill(IToolStackView tool, FluidStack resource, net.neoforged.neoforge.fluids.capability.IFluidHandler.FluidAction action) {
    int totalFilled = 0;
   ...
   */
  public FluidStack drain(IToolStackView tool, FluidStack resource, net.neoforged.neoforge.fluids.capability.IFluidHandler.FluidAction action) {
    if (resource.isEmpty()) {
   ...
   * @return Drained resource
   */
  public FluidStack drain(IToolStackView tool, int maxDrain, net.neoforged.neoforge.fluids.capability.IFluidHandler.FluidAction action) {
    if (maxDrain <= 0) {
      return FluidStack.EMPTY;
    }
    FluidStack drainedSoFar = FluidStack.EMPTY;
