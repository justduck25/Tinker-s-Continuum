...
public final class ToolBuildHandler {
   ...
   */
  private static void markDisplay(ItemStack stack) {
    CompoundTag nbt = stack.getOrDefault(DataComponents.CUSTOM_DATA, CustomData.EMPTY).copyTag();
    nbt.putBoolean(TooltipUtil.KEY_DISPLAY, true);
  ...
  public static ItemStack buildToolForRendering(Item item, ToolDefinition definition) {
    ...
    ItemStack stack = holder.areComponentsBound() ? new ItemStack(holder) : new ItemStack(Holder.direct(item, DataComponentMap.EMPTY));
