  ...
  public static void initBook() {
    ...
    TierRangeMaterialSectionTransformer.registerMaterialType(getResource("armor"), ArmorMaterialContent::new,
      Comparator.comparing(mat -> {
        ...
        if (registry.getMaterialStats(id, CHESTPLATE.getStatsId()).isPresent()) {
          return 4;
        }
      ...
      HELMET.getStatsId(), CHESTPLATE.getStatsId(), LEGGINGS.getStatsId(), BOOTS.getStatsId(), SHIELD.getStatsId(),
