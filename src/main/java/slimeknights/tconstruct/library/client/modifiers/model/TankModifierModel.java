...
public class TankModifierModel implements ModifierModel {
  ...
  private record CacheKey(Fluid fluid, DataComponentPatch tag, boolean partial) {}
  ...
  public void addQuads(IToolStackView tool, ModifierEntry modifier, Function<Material, TextureAtlasSprite> spriteGetter, Transformation transforms, boolean isLarge, int startTintIndex, Consumer<Collection<BakedQuad>> quadConsumer, @Nullable ItemLayerPixels pixels) {
    ...
    if (partial != null || full != null) {
      ...
      if (!fluid.isEmpty()) {
        ...
        if (mask != null) {
          FluidModifierModel.addQuads(fluid, mask, spriteGetter, transforms, quadConsumer, pixels);
        }
      }
    }
  }
