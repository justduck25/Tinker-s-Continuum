...
public abstract class MaterialArmorTextureSupplier implements ArmorTextureSupplier {
  ...
  public MaterialArmorTextureSupplier(Identifier prefix, Function<String, ArmorTexture>[] textures) {
    this.prefix = prefix;
  ...
  public static class Material extends MaterialArmorTextureSupplier {
    ...
    protected String getMaterial(ItemStack stack) {
      ...
      if (tag != null && tag.contains(ToolStack.TAG_MATERIALS)) {
        return tag.getListOrEmpty(ToolStack.TAG_MATERIALS).getStringOr(index, "");
      }
      return "";
    }
