...
public abstract class AbstractMaterialSpriteProvider {
  ...
  protected MaterialSpriteInfoBuilder buildMaterial(MaterialId name) {
    return buildMaterial(name.getId());
  }
  ...
  protected static class MaterialSpriteInfoBuilder {
    ...
    private MaterialSpriteInfoBuilder(Identifier texture) {
      this.texture = texture;
    }
    ...
    public MaterialSpriteInfoBuilder plating() {
      ...
      statType(PlatingMaterialStats.HELMET.getStatsId());
      statType(PlatingMaterialStats.CHESTPLATE.getStatsId());
      statType(PlatingMaterialStats.LEGGINGS.getStatsId());
      statType(PlatingMaterialStats.BOOTS.getStatsId());
      statType(PlatingMaterialStats.SHIELD.getStatsId());
      repairKit();
      return this;
    }
