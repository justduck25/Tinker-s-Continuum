...
public class TConstruct {
  ...
  public TConstruct(IEventBus bus) {
    ...
    NeoForge.EVENT_BUS.register(ModifierEvents.class);
  ...
  @SubscribeEvent
  static void gatherData(final GatherDataEvent.Server event) {
    ...
    generator.addProvider(server, new ItemTagProvider(packOutput, lookupProvider, blockTags.contentsGetter()));
    generator.addProvider(server, new FluidTagProvider(packOutput, lookupProvider));
    generator.addProvider(server, new EntityTypeTagProvider(packOutput, lookupProvider));
    generator.addProvider(server, new BlockEntityTypeTagProvider(packOutput, lookupProvider));
