...
class ToolHarvestLogicTest extends ToolItemTest {
  ...
  synchronized static void beforeAllToolLogic() {
    ...
    if (pickaxeTool == null) {
      ...
      ForgeRegistries.ITEMS.register(ResourceLocation.fromNamespaceAndPath("test", "pickaxe"), pickaxeTool);
    }
  }
  ...
  void calcSpeed_effective_withMiningModifier() {
    ...
    ForgeRegistries.ITEMS.register(ResourceLocation.fromNamespaceAndPath("test", "tool_with_mining_modifier"), toolWithMiningModifier);
