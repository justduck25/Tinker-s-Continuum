...
public class MaterialItemFixture {
  ...
  public static void init() {
    ...
    ForgeRegistries.ITEMS.register(ResourceLocation.fromNamespaceAndPath("test", "test_material"), MATERIAL_ITEM);
    ForgeRegistries.ITEMS.register(ResourceLocation.fromNamespaceAndPath("test", "test_material_2"), MATERIAL_ITEM_2);
    ForgeRegistries.ITEMS.register(ResourceLocation.fromNamespaceAndPath("test", "test_head"), MATERIAL_ITEM_HEAD);
    ForgeRegistries.ITEMS.register(ResourceLocation.fromNamespaceAndPath("test", "test_handle"), MATERIAL_ITEM_HANDLE);
    ForgeRegistries.ITEMS.register(ResourceLocation.fromNamespaceAndPath("test", "test_extra"), MATERIAL_ITEM_EXTRA);
  }
}
